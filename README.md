...
[Core][3]
```groovy
implementation 'com.frybits.rx.preferences:core:2.1.0'
```

[Coroutine/Flow][4]
```groovy
implementation 'com.frybits.rx.preferences:coroutine:2.1.0'
```

[LiveData][5]
```groovy
implementation 'com.frybits.rx.preferences:livedata:2.1.0'
```
...
```groovy
// Import BOM
implementation platform('com.frybits.rx.preferences:bom:2.1.0')
...
[13]:https://central.sonatype.com/artifact/com.frybits.rx.preferences/bom/2.1.0
